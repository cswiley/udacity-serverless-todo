...
[x] Fetch a certificate from Auth0 instead of hard coding it in an authorizer.

[x] Implement pagination support to work around a DynamoDB limitation that allows up to 1MB of data using a query method.
